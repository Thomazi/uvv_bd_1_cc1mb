...
CREATE ROLE gabriel WITH
  ...
  CREATEROLE
  REPLICATION
  ENCRYPTED PASSWORD 'SCRAM-SHA-256$4096:73psbvtEzLg/XC/TLnIp/A==$w0eRZzXs4IEPt95hiNH5mcx4EDJUZ4FiTfqXLinxcRk=:ipUyyAnTiXza6wf33yANljPM/zlL6oNzhIisoYXAdRY=';

ALTER ROLE gabriel SET search_path TO elmasri, "$user", public;
...
(
    ...
    CONSTRAINT localizacoes_departamento_fk FOREIGN KEY ("numero_departamento ")
...
(
    ...
    CONSTRAINT "projeto.unique" UNIQUE (nome_projeto),
    CONSTRAINT projeto_fk FOREIGN KEY ("numero_projeto  ")
        REFERENCES elmasri.departamento (numero_departamento) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION
        NOT VALID
...
(
    ...
    CONSTRAINT trabalha_em_fk FOREIGN KEY (cpf_funcionario)
        REFERENCES elmasri.funcionario (cpf) MATCH SIMPLE
        ON UPDATE NO ACTION
        ON DELETE NO ACTION,
    CONSTRAINT trabalha_em_fk2 FOREIGN KEY ("numero_projeto ")
